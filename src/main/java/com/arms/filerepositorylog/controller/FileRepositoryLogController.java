...
import com.arms.filerepositorylog.service.FileRepositoryLog;

@Slf4j
@Controller
@RequestMapping(value = {"/arms/fileRepositoryLog"})
public class FileRepositoryLogController extends SHVAbstractController<FileRepositoryLog, FileRepositoryLogDTO> {
