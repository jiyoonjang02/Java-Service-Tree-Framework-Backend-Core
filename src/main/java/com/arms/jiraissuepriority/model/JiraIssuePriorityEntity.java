...
@SequenceGenerator(name = "S_T_ARMS_JIRAISSUEPRIORITY", sequenceName = "S_T_ARMS_JIRAISSUEPRIORITY", allocationSize = 1)
public class JiraIssuePriorityEntity extends TreeSearchEntity implements Serializable {
    ...
    public JiraIssuePriorityEntity(Boolean copyBooleanValue) {
 	...
 	@Override
    @Id
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="S_T_ARMS_JIRAISSUEPRIORITY")
    @Column(name = "c_id")
    public Long getC_id() {
