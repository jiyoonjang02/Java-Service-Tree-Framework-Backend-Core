...
import com.arms.jiraissuestatelog.model.JiraIssueStateLogDTO;
import com.arms.jiraissuestatelog.service.JiraIssueStateLog;

@Slf4j
@Controller
@RequestMapping(value = {"/arms/jiraIssueStateLog"})
public class JiraIssueStateLogController extends SHVAbstractController<JiraIssueStateLog, JiraIssueStateLogDTO> {
