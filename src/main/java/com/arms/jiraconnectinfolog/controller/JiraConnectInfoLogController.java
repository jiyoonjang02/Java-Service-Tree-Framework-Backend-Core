...
public class JiraConnectInfoLogController extends SHVAbstractController<JiraConnectInfoLog, JiraConnectInfoLogDTO> {
    ...
    public void initialize() {
        setJsTreeHibernateService(jiraConnectInfoLog);
    }
