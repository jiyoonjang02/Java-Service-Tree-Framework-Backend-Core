...
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_REQCOMMENTLOG", allocationSize = 1)
public class ReqCommentLogDTO extends JsTreeHibernateSearchDTO implements Serializable {
