...
import com.arms.jiraprojectlog.service.JiraProjectLog;

@Slf4j
@Controller
@RequestMapping(value = {"/arms/jiraProjectLog"})
public class JiraProjectLogController extends TreeAbstractController<JiraProjectLog, JiraProjectLogEntity> {
