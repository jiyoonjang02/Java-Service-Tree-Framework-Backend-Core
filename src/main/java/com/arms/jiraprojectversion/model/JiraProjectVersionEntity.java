...
@SequenceGenerator(name = "S_T_ARMS_JIRAPROJECTVERSION", sequenceName = "S_T_ARMS_JIRAPROJECTVERSION", allocationSize = 1)
public class JiraProjectVersionEntity extends TreeSearchEntity implements Serializable {
    ...
    public JiraProjectVersionEntity(Boolean copyBooleanValue) {
 	...
 	@Override
    @Id
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="S_T_ARMS_JIRAPROJECTVERSION")
    @Column(name = "c_id")
    public Long getC_id() {
