 ...
 * </pre>
 */
package com.arms.armsinstall.controller;
...
import com.arms.armsinstall.service.ArmsInstall;

@Slf4j
@Controller
@RequestMapping(value = {"/arms/armsInstall"})
public class ArmsInstallController extends TreeAbstractController<ArmsInstall, ArmsInstallEntity> {

    @Autowired
    @Qualifier("armsInstall")
    private ArmsInstall armsInstall;

    @PostConstruct
    public void initialize() {
        setTreeService(armsInstall);
    }
