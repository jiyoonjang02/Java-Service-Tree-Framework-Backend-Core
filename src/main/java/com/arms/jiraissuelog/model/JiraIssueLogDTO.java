...
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_JIRAISSUELOG", allocationSize = 1)
public class JiraIssueLogDTO extends JsTreeHibernateSearchDTO implements Serializable {

    public JiraIssueLogDTO() {
        super();
    }

    public JiraIssueLogDTO(Boolean copyBooleanValue) {
        super();
