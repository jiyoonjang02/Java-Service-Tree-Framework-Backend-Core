...
@Getter
@Setter
@Table(name = "T_ARMS_JIRAISSUERESOLUTION")
@SelectBeforeUpdate(value=true)
@DynamicInsert(value=true)
@DynamicUpdate(value=true)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class JiraIssueResolutionEntity extends TreeSearchEntity implements Serializable {

    public JiraIssueResolutionEntity() {
        super();
    }

    public JiraIssueResolutionEntity(Boolean copyBooleanValue) {
        super();
