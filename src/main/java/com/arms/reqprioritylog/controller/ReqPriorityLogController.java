...
import com.arms.reqprioritylog.model.ReqPriorityLogDTO;
import com.arms.reqprioritylog.service.ReqPriorityLog;

@Slf4j
@Controller
@RequestMapping(value = {"/arms/reqPriorityLog"})
public class ReqPriorityLogController extends SHVAbstractController<ReqPriorityLog, ReqPriorityLogDTO> {
    ...
    public void initialize() {
        setJsTreeHibernateService(reqPriorityLog);
    }
