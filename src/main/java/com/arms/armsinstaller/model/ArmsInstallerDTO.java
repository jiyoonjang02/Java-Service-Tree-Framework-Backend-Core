...
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_ARMSINSTALLER", allocationSize = 1)
public class ArmsInstallerDTO extends JsTreeHibernateSearchDTO implements Serializable {

    public ArmsInstallerDTO() {
        super();
    }

    public ArmsInstallerDTO(Boolean copyBooleanValue) {
        super();
