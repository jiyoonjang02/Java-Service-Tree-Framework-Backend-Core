...
@SequenceGenerator(name = "S_T_ARMS_JIRAISSUESTATE", sequenceName = "S_T_ARMS_JIRAISSUESTATE", allocationSize = 1)
public class JiraIssueStateEntity extends TreeSearchEntity implements Serializable {
    ...
    public JiraIssueStateEntity(Boolean copyBooleanValue) {
 	...
 	@Override
    @Id
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="S_T_ARMS_JIRAISSUESTATE")
    @Column(name = "c_id")
    public Long getC_id() {
