...
@SequenceGenerator(name = "JsTreeSequence", sequenceName = "S_T_ARMS_JIRAISSUE", allocationSize = 1)
public class JiraIssueDTO extends JsTreeHibernateSearchDTO implements Serializable {

    public JiraIssueDTO() {
        super();
    }

    public JiraIssueDTO(Boolean copyBooleanValue) {
        super();
