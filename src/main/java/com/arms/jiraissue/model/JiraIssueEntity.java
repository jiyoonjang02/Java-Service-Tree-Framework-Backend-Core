...
@SequenceGenerator(name = "S_T_ARMS_JIRAISSUE", sequenceName = "S_T_ARMS_JIRAISSUE", allocationSize = 1)
public class JiraIssueEntity extends TreeSearchEntity implements Serializable {
    ...
    public JiraIssueEntity(Boolean copyBooleanValue) {
 	...
 	@Override
    @Id
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="S_T_ARMS_JIRAISSUE")
    @Column(name = "c_id")
    public Long getC_id() {
