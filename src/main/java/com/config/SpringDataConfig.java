...
public class SpringDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerJpaFactory() {
        ...
        em.setPackagesToScan("com.egovframework.ple.treeframework.springdata.onlineV2.*");
    ...
    public LocalSessionFactoryBean sessionJpaFactory() {
        ...
        sessionFactory.setPackagesToScan("com.egovframework.ple.treeframework.springdata.onlineV2.*");
